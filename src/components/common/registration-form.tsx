...
export default function RegistrationForm() {
    ...
    const form = useForm<
        z.infer<typeof studentSchema | typeof facultyOrEmployeeSchema | typeof facultyOrEmployeeSchema> & {
            couponCode?: string;
        }
    >({
    ...
    const onSubmit = async (values: z.infer<typeof studentSchema | typeof baseSchema>) => {
        await handlePayment();
