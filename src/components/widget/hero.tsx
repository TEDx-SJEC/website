...
const FlipCard = ({ value, label }: { value: number; label: string }) => {
    return (
        <motion.div
            className="flex flex-col items-center justify-center bg-gradient-to-b from-blackTheme to-redTheme rounded-lg shadow-lg p-2 w-full aspect-square overflow-hidden border border-red-500/30"
...
export default function HeroHighlight() {
    ...
    return (
        <section className="w-full lg:px-10 px-5 h-full bg-gradient-to-b from-blackTheme  text-white overflow-hidden relative">
            <svg
                ref={svgRef}
