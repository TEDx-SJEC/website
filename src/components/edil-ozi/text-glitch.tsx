...
const TextGlitchEffect: FC<Props> = ({ textOne, textTwo, className }) => {
  return (
    ...
    >
      ...
      <span className="absolute left-0 top-0 text-white md:text-whiteTheme transition-transform duration-300 ease-in-out group-hover:-translate-y-full whitespace-nowrap">
        {textOne}
      </span>
